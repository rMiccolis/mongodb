...
cat $repository_root_dir/apps/mongodb/res/values.yaml | envsubst | tee $repository_root_dir/apps/mongodb/res/values-submitted.yaml

helm install mongodb oci://registry-1.docker.io/bitnamicharts/mongodb -n mongodb -f $repository_root_dir/apps/mongodb/res/values-submitted.yaml
